...
const getRoundLine = (round, wantsToPlayAgain)=>{
    if (round === 1) return "Welcome to Mr.Dollars Coder Speed Test!";
...
},{"./linux":"5rmrL","./react":"3Lunc","./tensorflow":"izyqb","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5rmrL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const chooseOptionErrorMessages = [
    ...
    [
        "Ok, wow... Do me a favor here with a1",
